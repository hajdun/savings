...
@Component({
  selector: 'add-settings-form',
  templateUrl: './add-settings-form.component.html',
  styleUrls: ['./add-settings-form.component.scss']
})
export class AddSettingsFormComponent implements OnInit {
